...
func main() {
	...
	go func() {
		...
		for {
			...
			queue <- i
			// o for só vai prosseguir quando alguém acessar queue, considerando a anotação de queue abaixo #1
			i++
		}
...
// #1 Quando um valor é enviado para o canal, ele é armazenado temporariamente no canal até ser lido por outra goroutine.
